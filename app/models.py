...
import secrets
#-------------------------------------------------------------------------
#for pagination here im making a class this class will be used by other class whenever they need it
...
class SearchableMixin(object):
    ...
    def search(cls, expression, page, per_page):
        ...
        if total == 0:
            return cls.query.filter_by(id=0), 0  # Return empty query

        when = [(cls.id == id, index) for index, id in enumerate(ids)]
        return (
            cls.query.filter(cls.id.in_(ids))
        .order_by(sa.case(*when))
        .all(),
        total
    )
...
#------------------------------------------TOKENS------------------------------------------
    ...
    def check_token(token):
        ...
        return user
#--------------------------------------------------------------------------------------------
#this part is for api counting post
